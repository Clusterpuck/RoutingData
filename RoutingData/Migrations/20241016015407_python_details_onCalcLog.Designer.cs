...
namespace RoutingData.Migrations
{
    ...
    [Migration("20241016015407_python_details_onCalcLog")]
    partial class python_details_onCalcLog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RoutingData.Models.Calculation", b =>
                {
                    ...
                    b.Property<int>("CalculationNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CalculationNumber"));
                    ...
                    b.Property<string>("PythonPayload")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
